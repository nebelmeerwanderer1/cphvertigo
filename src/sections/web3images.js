...
import Tokens from "assets/ext_tokens.jpg";
import Pugcard from "assets/ext_pugcard.PNG";


import Briefcase from "assets/core-feature/ethereum.svg";
import Secure from "assets/core-feature/cardano.svg";

const data = {
  subTitle: "technologies",
  title: "product functionality & technology capability",
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
...
export default function CoreFeature() {
  return (
    <section sx={styles.coreFeature} id="technology">
      <Container sx={styles.containerBox}>
        ...
        <Box sx={styles.thumbnail}>
          <Image src={Pugcard} alt="Thumbnail" />
        </Box>
        <Box sx={styles.thumbnail}>
          <Image src={Tokens} alt="Thumbnail" />
        </Box>
      </Container>
    </section>
  );
