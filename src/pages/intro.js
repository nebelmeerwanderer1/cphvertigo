/** @jsx jsx */
import { jsx, Container, Box, Grid, Text, Button, Heading } from "theme-ui";
...
function handleClick() {
    const exampleBtn = document.getElementById('myButton');  
...
export default function Intro() {
  return (
     <ThemeProvider theme={theme}>
      <StickyProvider>
    <section sx={styles.coreFeature} id="intro">
